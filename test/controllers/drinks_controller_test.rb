...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { Amount: @drink.Amount, Name: @drink.Name, cafeinAmount: @drink.cafeinAmount } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { Amount: @drink.Amount, Name: @drink.Name, cafeinAmount: @drink.cafeinAmount } }
